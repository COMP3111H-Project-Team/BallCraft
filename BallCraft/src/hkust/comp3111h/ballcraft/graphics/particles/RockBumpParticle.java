...
public class RockBumpParticle extends MagicParticle {
    ...
    public RockBumpParticle(double theta, double rho, double r) {
        super(
    ...
    public static void loadTexture(GL10 gl, Context context) {
        Bitmap bmp = BitmapFactory.decodeResource(
                context.getResources(), R.drawable.fire_particle);
