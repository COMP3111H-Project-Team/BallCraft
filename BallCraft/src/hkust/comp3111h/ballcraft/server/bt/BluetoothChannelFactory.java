...
abstract interface BluetoothChannelFactory {
    /**
     * Create a new server socket object. This is intended to be used by the
     * client side. That is, it creates a channel that connect to the server.
     * 
    ...
    /**
     * Create a new client socket object. This is intended to be used by the
     * server side. That is, it creates a channel that connect to the client.
     * 
